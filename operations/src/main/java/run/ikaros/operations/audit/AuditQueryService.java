...
public class AuditQueryService {
    ...
    public Mono<PageResponse<AuditEventEntity>> search(UUID actorId, String requestId, Instant fromTime, Instant toTime,
                                                        int page, int size) {
        ...
        return Mono.zip(repository.search(actorId, normalizedRequestId, fromTime, toTime, size, offset).collectList(),
                repository.countSearch(actorId, normalizedRequestId, fromTime, toTime))
