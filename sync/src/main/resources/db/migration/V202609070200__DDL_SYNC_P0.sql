CREATE TABLE IF NOT EXISTS drive_device (
...
CREATE INDEX IF NOT EXISTS idx_drive_device_user ON drive_device (user_id, trust_state, last_seen_at DESC);

CREATE TABLE IF NOT EXISTS offline_download_intent (
...
CREATE INDEX IF NOT EXISTS idx_offline_download_device_state ON offline_download_intent (user_id, device_id, state, updated_at DESC);
...
CREATE INDEX IF NOT EXISTS idx_offline_cache_device_access ON offline_cache_entry (user_id, device_id, state, last_accessed_at DESC);

CREATE TABLE IF NOT EXISTS offline_download_manifest (
...
CREATE TABLE IF NOT EXISTS offline_download_manifest_item (
