...
public class EpisodeCollectionEndpoint implements CoreEndpoint {
    ...
    public RouterFunction<ServerResponse> endpoint() {
        ...
        return SpringdocRouteBuilder.route()
            ...
            .PUT("/collection/episode/progress/{userId}/{episodeId}/{progress}",
                this::updateEpisodeCollectionProgress,
                builder -> builder.operationId("UpdateEpisodeCollectionProgress")
                    .tag(tag)
                    .parameter(parameterBuilder()
                        .name("userId")
                        .description("User id")
    ...
    private Mono<ServerResponse> updateEpisodeCollectionProgress(ServerRequest serverRequest) {
        String userId = serverRequest.pathVariable("userId");
        String episodeId = serverRequest.pathVariable("episodeId");
        String progress = serverRequest.pathVariable("progress");
        return episodeCollectionService
            .updateEpisodeCollectionProgress(
                Long.valueOf(userId),
