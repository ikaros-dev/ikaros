...
@Table("music_playlist") public record MusicPlaylistEntity(@Id UUID id,@Column("owner_id") UUID ownerId,String name,String description,@Column("created_at") Instant createdAt,@Column("updated_at") Instant updatedAt,@Version Long version) {}
