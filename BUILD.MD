...
- Vue: 3
- IDE: IntelliJ IDEA 
- Database: postgres:18.1-alpine

建议先Fork一份仓库,

您可以通过`git`拉取代码库
```shell
git clone https://github.com/{youusername}/ikaros.git
cd ikaros
```
- {youusername}: 替换成你的GitHub用户名，你fork之后对应的库链接就是替换后的链接。
...
借助Graalvm编译本地镜像 #433 目前还有问题，暂时不可用。
