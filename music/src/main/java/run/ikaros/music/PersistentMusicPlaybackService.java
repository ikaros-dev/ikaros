...
public class PersistentMusicPlaybackService implements MusicPlaybackService {
  ...
  public Flux<MusicPlaybackSessionView> active(UUID owner) { return sessions.findAllByOwnerIdAndStateOrderByStartedAtDesc(owner, MusicPlaybackState.ACTIVE).take(100).map(this::view); }
