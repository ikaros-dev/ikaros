...
CREATE INDEX IF NOT EXISTS idx_planning_task_owner_status ON planning_task (owner_id, status, updated_at DESC);
...
CREATE INDEX IF NOT EXISTS idx_planning_project_owner_updated ON planning_project (owner_id, updated_at DESC);
ALTER TABLE planning_task DROP CONSTRAINT IF EXISTS fk_planning_task_project;
...
CREATE TABLE IF NOT EXISTS planning_task_tag (
...
CREATE INDEX IF NOT EXISTS idx_planning_task_tag_tag ON planning_task_tag (tag_id, task_id);

CREATE TABLE IF NOT EXISTS planning_recurrence (
...
CREATE INDEX IF NOT EXISTS idx_planning_recurrence_due ON planning_recurrence (active, next_run_at);

CREATE TABLE IF NOT EXISTS planning_time_block (
    id UUID PRIMARY KEY DEFAULT uuid_v7(), owner_id UUID NOT NULL, title VARCHAR(512) NOT NULL,
...
CREATE INDEX IF NOT EXISTS idx_planning_time_block_owner_time ON planning_time_block (owner_id, start_at, end_at);
...
CREATE INDEX IF NOT EXISTS idx_planning_reminder_due ON planning_reminder (status, trigger_at);
CREATE INDEX IF NOT EXISTS idx_planning_reminder_owner ON planning_reminder (owner_id, trigger_at);
...
CREATE TABLE IF NOT EXISTS planning_goal_task (
...
CREATE INDEX IF NOT EXISTS idx_planning_goal_owner_status ON planning_goal (owner_id, status, updated_at DESC);
CREATE INDEX IF NOT EXISTS idx_planning_goal_task_task ON planning_goal_task (task_id, goal_id);

CREATE TABLE IF NOT EXISTS planning_task_dependency (
...
CREATE INDEX IF NOT EXISTS idx_planning_task_dependency_reverse ON planning_task_dependency (depends_on_task_id, task_id);
CREATE TABLE IF NOT EXISTS planning_project_section (
...
CREATE INDEX IF NOT EXISTS idx_planning_project_section_project_position ON planning_project_section (project_id, position);
ALTER TABLE planning_task DROP CONSTRAINT IF EXISTS fk_planning_task_section;
...
CREATE TABLE IF NOT EXISTS planning_time_entry (
...
CREATE INDEX IF NOT EXISTS idx_planning_time_entry_task_created ON planning_time_entry (owner_id, task_id, created_at DESC);

CREATE TABLE IF NOT EXISTS planning_focus_session (
...
CREATE INDEX IF NOT EXISTS idx_planning_focus_session_owner_started ON planning_focus_session (owner_id, started_at DESC);

CREATE TABLE IF NOT EXISTS planning_habit (
...
CREATE TABLE IF NOT EXISTS planning_habit_check_in (
...
CREATE INDEX IF NOT EXISTS idx_planning_habit_owner_created ON planning_habit (owner_id, created_at DESC);
CREATE INDEX IF NOT EXISTS idx_planning_habit_check_in_habit_occurred ON planning_habit_check_in (owner_id, habit_id, occurred_at DESC);

CREATE TABLE IF NOT EXISTS planning_milestone (
    id UUID PRIMARY KEY DEFAULT uuid_v7(), owner_id UUID NOT NULL, title VARCHAR(512) NOT NULL, description TEXT,
...
CREATE INDEX IF NOT EXISTS idx_planning_milestone_owner_due ON planning_milestone (owner_id, due_at);
CREATE INDEX IF NOT EXISTS idx_planning_milestone_goal_due ON planning_milestone (goal_id, due_at);

CREATE TABLE IF NOT EXISTS planning_review (
...
CREATE INDEX IF NOT EXISTS idx_planning_review_owner_period ON planning_review (owner_id, period, period_start DESC);

CREATE TABLE IF NOT EXISTS planning_okr_cycle (
    id UUID PRIMARY KEY DEFAULT uuid_v7(), owner_id UUID NOT NULL, name VARCHAR(128) NOT NULL,
...
CREATE TABLE IF NOT EXISTS planning_okr_objective (
...
CREATE TABLE IF NOT EXISTS planning_okr_key_result (
...
CREATE INDEX IF NOT EXISTS idx_planning_okr_cycle_owner_start ON planning_okr_cycle (owner_id, start_at DESC);
CREATE INDEX IF NOT EXISTS idx_planning_okr_objective_cycle ON planning_okr_objective (owner_id, cycle_id, created_at DESC);
CREATE INDEX IF NOT EXISTS idx_planning_okr_key_result_objective ON planning_okr_key_result (owner_id, objective_id, created_at DESC);

CREATE TABLE IF NOT EXISTS planning_okr_check_in (
...
CREATE INDEX IF NOT EXISTS idx_planning_okr_check_in_key_result ON planning_okr_check_in (owner_id, key_result_id, created_at DESC);

CREATE TABLE IF NOT EXISTS planning_project_member (
...
CREATE INDEX IF NOT EXISTS idx_planning_project_member_user ON planning_project_member (user_id, project_id);

CREATE TABLE IF NOT EXISTS planning_task_assignment (
...
CREATE INDEX IF NOT EXISTS idx_planning_task_assignment_assignee ON planning_task_assignment (assignee_id, task_id);
...
CREATE INDEX IF NOT EXISTS idx_planning_comment_target_created ON planning_comment (target_type, target_id, created_at);

CREATE TABLE IF NOT EXISTS planning_important_date (
    id UUID PRIMARY KEY DEFAULT uuid_v7(), owner_id UUID NOT NULL, title VARCHAR(512) NOT NULL, description TEXT,
...
CREATE INDEX IF NOT EXISTS idx_planning_important_date_owner_occurs ON planning_important_date (owner_id, occurs_at);
