 ...
 *
 * @export
 * @interface EpisodeSequenceRegularResult
 */
export interface EpisodeSequenceRegularResult {
  /**
   *
   * @type {any}
   * @memberof EpisodeSequenceRegularResult
   */
  matched?: any;
  /**
   *
   ...
   * @memberof EpisodeSequenceRegularResult
   */
  epGroup?: EpisodeSequenceRegularResultEpGroupEnum;
  /**
   *
   * @type {any}
   * @memberof EpisodeSequenceRegularResult
...
export const EpisodeSequenceRegularResultEpGroupEnum = {
  Main: "MAIN",
...
export type EpisodeSequenceRegularResultEpGroupEnum =
  (typeof EpisodeSequenceRegularResultEpGroupEnum)[keyof typeof EpisodeSequenceRegularResultEpGroupEnum];
