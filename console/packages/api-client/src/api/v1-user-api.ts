 ...
 * @export
 */
export const V1UserApiAxiosParamCreator = function (
  configuration?: Configuration
) {
  return {
    /**
     * Change user role by username and roleId.
     * @param {any} username Username for user.
     * @param {any} roleId Id for role.
    ...
    changeUserRole: async (
      ...
      const localVarPath = `/api/v1/user/{username}/role`.replace(
        `{${"username"}}`,
    ...
    deleteById1: async (
      ...
      const localVarPath = `/api/v1/user/id/{id}`.replace(
        `{${"id"}}`,
    ...
    existUserByEmail: async (
      ...
      const localVarPath = `/api/v1/user/email/exists/{email}`.replace(
        `{${"email"}}`,
    ...
    existUserByUsername: async (
      ...
      const localVarPath = `/api/v1/user/username/exists/{username}`.replace(
        `{${"username"}}`,
        encodeURIComponent(String(username))
      );
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
 ...
 * @export
 */
export const V1UserApiFactory = function (
  configuration?: Configuration,
  basePath?: string,
  axios?: AxiosInstance
) {
  ...
  return {
    /**
     * Change user role by username and roleId.
     * @param {V1UserApiChangeUserRoleRequest} requestParameters Request parameters.
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     */
    changeUserRole(
      requestParameters: V1UserApiChangeUserRoleRequest,
      options?: AxiosRequestConfig
    ): AxiosPromise<void> {
      return localVarFp
        .changeUserRole(
    ...
    /**
     * Delete user by id..
     * @param {V1UserApiDeleteById1Request} requestParameters Request parameters.
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     */
    deleteById1(
      requestParameters: V1UserApiDeleteById1Request,
      options?: AxiosRequestConfig
    ): AxiosPromise<void> {
      return localVarFp
    ...
    /**
     * Exist user by email.
     * @param {V1UserApiExistUserByEmailRequest} requestParameters Request parameters.
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     */
    existUserByEmail(
      requestParameters: V1UserApiExistUserByEmailRequest,
      options?: AxiosRequestConfig
    ): AxiosPromise<any> {
      return localVarFp
    ...
    /**
     * Exist user by username.
     * @param {V1UserApiExistUserByUsernameRequest} requestParameters Request parameters.
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     */
    existUserByUsername(
      requestParameters: V1UserApiExistUserByUsernameRequest,
      options?: AxiosRequestConfig
    ): AxiosPromise<any> {
      return localVarFp
     ...
     * @throws {RequiredError}
     */
    getUsers(options?: AxiosRequestConfig): AxiosPromise<any> {
      return localVarFp
        .getUsers(options)
        .then((request) => request(axios, basePath));
    },
    /**
     * Create user.
     * @param {V1UserApiPostUserRequest} requestParameters Request parameters.
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     */
    postUser(
      requestParameters: V1UserApiPostUserRequest,
      options?: AxiosRequestConfig
    ): AxiosPromise<User> {
      return localVarFp
     ...
     */
    updateUser(
      requestParameters: V1UserApiUpdateUserRequest,
      options?: AxiosRequestConfig
    ): AxiosPromise<User> {
      return localVarFp
...
/**
 * Request parameters for changeUserRole operation in V1UserApi.
 * @export
 * @interface V1UserApiChangeUserRoleRequest
 */
export interface V1UserApiChangeUserRoleRequest {
  /**
   * Username for user.
   * @type {any}
   * @memberof V1UserApiChangeUserRole
   */
...
/**
 * Request parameters for deleteById1 operation in V1UserApi.
 * @export
 * @interface V1UserApiDeleteById1Request
 */
export interface V1UserApiDeleteById1Request {
  /**
   *
   * @type {any}
   * @memberof V1UserApiDeleteById1
   */
  readonly id: any;
}

/**
 * Request parameters for existUserByEmail operation in V1UserApi.
 * @export
 * @interface V1UserApiExistUserByEmailRequest
 */
export interface V1UserApiExistUserByEmailRequest {
  /**
   *
   * @type {any}
   * @memberof V1UserApiExistUserByEmail
   */
  readonly email: any;
}

/**
 * Request parameters for existUserByUsername operation in V1UserApi.
 * @export
 * @interface V1UserApiExistUserByUsernameRequest
 */
export interface V1UserApiExistUserByUsernameRequest {
  /**
   *
   * @type {any}
   * @memberof V1UserApiExistUserByUsername
   */
  readonly username: any;
}

/**
 * Request parameters for postUser operation in V1UserApi.
 * @export
 * @interface V1UserApiPostUserRequest
 */
export interface V1UserApiPostUserRequest {
  /**
   * User info.
   * @type {CreateUserReqParams}
   * @memberof V1UserApiPostUser
   */
...
export class V1UserApi extends BaseAPI {
  ...
  public changeUserRole(
    ...
    return V1UserApiFp(this.configuration)
      .changeUserRole(
        requestParameters.username,
        requestParameters.roleId,
        options
