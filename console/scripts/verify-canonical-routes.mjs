...
for (const target of ["/resources/library", "/storage/overview", "/apps/overview", "/system/access/users", "/system/integrations/apps", "/system/communications/notifications", "/system/settings/parameters", "/system/operations/health"]) {
