...
const pages = [
  ...
  ["AppsOverview", "overview"], ["Drive", "drive"], ["DriveNodeDetail", "drive/nodes/:nodeId"], ["DriveTransfers", "drive/transfers"], ["DriveSync", "drive/sync"], ["DriveConflicts", "drive/conflicts"], ["DriveTrash", "drive/trash"], ["DriveSettings", "drive/settings"], ["Documents", "documents"], ["DocumentEditor", "documents/:id/edit"], ["Media", "media"], ["Planning", "planning"], ["Finance", "finance"], ["PrivateNotes", "private-notes"], ["Passwords", "passwords"], ["AI", "ai"], ["Sharing", "sharing"], ["Analytics", "analytics"], ["Automation", "automation"], ["PluginApps", "plugins"], ["PluginApp", "plugins/:appId"],
  ["SystemUsers", "users"], ["SystemRolesPermissions", "roles-permissions"], ["SystemAuthentication", "authentication"], ["SystemPlugins", "plugins"], ["SystemExternalIntegrations", "external"], ["SystemEventDelivery", "events"], ["SystemNotifications", "notifications"], ["SystemAudit", "audit"], ["SystemParameters", "parameters"], ["SystemHealth", "health"], ["SystemDiagnostics", "diagnostics"],
...
for (const target of ["/resources/library", "/storage/overview", "/apps/overview", "/system/access/users", "/system/integrations/plugins", "/system/communications/notifications", "/system/settings/parameters", "/system/operations/health"]) {
