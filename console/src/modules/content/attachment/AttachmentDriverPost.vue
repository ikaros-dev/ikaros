	...
	type: [
		{
			required: true,
			message: t(
				'module.attachment.driver.post.message.form-rule.type.required'
			),
			trigger: 'blur',
		},
	],
	name: [
		{
			required: true,
			message: t(
				'module.attachment.driver.post.message.form-rule.name.required'
			),
			trigger: 'blur',
		},
	],
	mount_name: [
		{
			required: true,
			message: t(
				'module.attachment.driver.post.message.form-rule.mount_name.required'
			),
			trigger: 'blur',
		},
	],
	remote_path: [
		{
			required: true,
			message: t(
				'module.attachment.driver.post.message.form-rule.remote_path.required'
			),
			trigger: 'blur',
		},
	],
...
const updateTypeNames = async () => {
	typeNames.value = attDriverFetchers.value
	...
	<el-row>
		<el-col :span="24">
			...
			>
				...
				<el-form-item
					:label="t('module.attachment.driver.table.colum.label.name')"
					prop="name"
				>
					...
					<el-select v-model="driver.name" @visible-change="onVisibleChage">
						<el-option
							...
							:key="typeName as string"
							:label="typeName as string"
							:value="typeName"
						/>
					</el-select>
				</el-form-item>
				<el-form-item
					:label="t('module.attachment.driver.table.colum.label.mount_name')"
					prop="mount_name"
				>
					<el-input
						v-model="driver.mount_name"
						placeholder="LocalPlayTest | NetPanMountAttName"
					></el-input>
				</el-form-item>
				<el-form-item
					:label="
						t('module.attachment.driver.table.colum.label.mount_remote_path')
					"
					prop="remote_path"
				>
					<el-input
						v-model="driver.remote_path"
						clearable
						placeholder="/mnt/playtest | 2989952445870372007"
					></el-input>
				</el-form-item>
				<el-form-item
					:label="t('module.attachment.driver.table.colum.label.access_token')"
				>
					<el-input
				...
				>
					<el-input
						...
						clearable
						placeholder="Play Test Driver"
					></el-input>
				</el-form-item>
				<el-form-item>
					<el-button plain :loading="driverBtnLoading" @click="submitForm()">
