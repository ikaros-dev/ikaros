...
<template>
	<el-row>
		<el-col :span="24">
			<el-button
				:icon="FolderAdd"
				@click="router.push('/attachment/driver/post')"
			>
	...
	<el-row>
		<el-col :span="24">
			<el-table :data="attDrivers" stripe style="width: 100%">
				...
				<el-table-column
					prop="enable"
					:label="t('module.attachment.driver.table.colum.label.enable')"
					width="80"
				>
				...
				<el-table-column
					:label="t('module.attachment.driver.table.colum.label.operations')"
					width="300"
				>
					<template #default="scope">
						<el-popconfirm
							:title="
								scope.row.enable
									? t(
											'module.attachment.driver.table.colum.label.operation.popconfirm.disable_title'
										)
									: t(
											'module.attachment.driver.table.colum.label.operation.popconfirm.enable_title'
										)
							"
							...
							<template #reference>
								<el-button :loading="isEnableButtonLoading">
									<span v-if="scope.row.enable">
										{{
											t(
												'module.attachment.driver.table.colum.label.operation.disable'
											)
										}}
									</span>
									<span v-else>
										{{
											t(
												'module.attachment.driver.table.colum.label.operation.enable'
											)
										}}
									</span>
								</el-button>
						...
						<el-button
							@click="router.push('/attachment/driver/put/' + scope.row.id)"
						>
							{{
						...
						<el-popconfirm
							:title="
								t(
									'module.attachment.driver.table.colum.label.operation.popconfirm.title'
								)
							"
							:confirm-button-text="t('common.button.confirm')"
							:cancel-button-text="t('common.button.cancel')"
						...
						>
							<template #reference>
								<el-button type="danger" :loading="isDeleteButtonLoading">
									{{
										t(
											'module.attachment.driver.table.colum.label.operation.delete'
										)
									}}
								</el-button>
							</template>
