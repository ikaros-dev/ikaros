...
const onConfirm = () => {
	emit('closeWithAttachment', currentSelectionAttachment.value as Attachment);
...
<template>
	...
	<el-dialog
		...
		:title="t('module.attachment.dialog.select.title')"
		width="85%"
		@close="onClose"
	>
		<el-row>
				...
				<el-row>
					<el-col :xs="24" :sm="24" :md="12" :lg="12" :xl="12">
						<el-button plain @click="attachmentUploadDrawerVisible = true">
							...
							{{ t('module.attachment.dialog.select.operate.upload') }}
						</el-button>
					</el-col>
					<el-col :xs="24" :sm="24" :md="12" :lg="12" :xl="12">
						<el-form-item
			...
			<el-col :xs="24" :sm="24" :md="12" :lg="12" :xl="12">
				<el-input
					...
					:placeholder="t('module.attachment.dialog.select.search.placeholder')"
					clearable
		...
		<el-row>
			<el-col :span="24">
				...
				>
					...
					<el-table-column
						prop="name"
						:label="t('module.attachment.dialog.select.table.colum.label.name')"
