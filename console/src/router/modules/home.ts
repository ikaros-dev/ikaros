...
export default {
  ...
  children: [
    ...
    subsystem("/ai", "AiCenter", "AI 智能", "ep:magic-stick", [
    ...
    subsystem("/operations", "OperationsCenter", "系统运维", "ep:monitor", [
    ...
    subsystem("/security", "SecurityCenter", "身份安全", "ep:lock", [
    ...
    subsystem("/integration", "IntegrationCenter", "集成自动化", "ep:connection", [
    ...
    subsystem("/communications", "CommunicationsCenter", "沟通与审计", "ep:notification", [
    ...
    subsystem("/analytics", "AnalyticsCenter", "数据分析", "ep:data-analysis", [
    ...
    subsystem("/platform", "ConfigurationCenter", "平台配置", "ep:setting", [
    ...
    subsystem("/password", "PasswordCenter", "密码管理", "ep:key", [
    ...
    subsystem("/notes", "NotesCenter", "私密笔记", "ep:lock", [
    ...
    subsystem("/account", "AccountCenter", "个人中心", "ep:user", [
    ...
    subsystem("/resources", "ResourceCenter", "资源中心", "ep:files", [
    ...
    subsystem("/content", "ContentCenter", "内容与媒体", "ep:video-camera", [
    ...
    subsystem("/storage", "StorageCenter", "存储与云盘", "ep:box", [
    ...
    subsystem("/ingestion", "IngestionCenter", "导入与处理", "ep:upload", [
    ...
    subsystem("/collaboration", "CollaborationCenter", "协作与分享", "ep:chat-line-round", [
    ...
    subsystem("/planning", "PlanningCenter", "计划与财务", "ep:calendar", [
    ...
    subsystem("/identity", "IdentityCenter", "身份与安全", "ep:lock", [
