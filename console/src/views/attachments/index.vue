...
<template>
  <main class="p-4 md:p-6">
    <div class="flex flex-wrap items-start justify-between gap-4 mb-6">
      ...
      <div class="flex gap-2"><el-input v-model="resourceId" placeholder="Resource ID" clearable @keyup.enter="load" /><el-button type="primary" :loading="loading" @click="load">查询附件</el-button></div>
    </div>
