...
const error = ref("");
const message = ref("");
const form = ref({ deviceId: "", driveSpaceId: "", localScopeId: "", localDisplayPath: "", sourceKind: "DIRECTORY", deletePolicy: "KEEP_REMOTE", conflictPolicy: "PRESERVE_BOTH" });
