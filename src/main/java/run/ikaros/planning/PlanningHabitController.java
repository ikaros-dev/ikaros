...
public class PlanningHabitController {
    ...
    @DeleteMapping("/{habitId}") public Mono<PlanningHabitView> archive(@RequestHeader("X-Ikaros-Actor-Id") UUID ownerId, @PathVariable UUID habitId) { return service.archive(ownerId, habitId); }
