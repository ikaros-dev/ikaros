...
public class PersistentDownloadService implements DownloadService {
    ...
    @Override public Flux<DownloadView> list(UUID user, UUID device) { return repository.findAllByUserIdAndDeviceIdOrderByCreatedAtDesc(user,device).map(this::view); }
