...
(
    ...
    origin_type              varchar(32) not null default 'STORAGE_PROVIDER',
    auth_mode                varchar(32) not null default 'DELIVERY_GRANT',
    ...
    check (origin_type in ('STORAGE_PROVIDER', 'SERVER_PROXY')),
    check (auth_mode in ('DELIVERY_GRANT', 'PROVIDER_SIGNED', 'SERVER_AUTH')),
