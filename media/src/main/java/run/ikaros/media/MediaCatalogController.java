...
public class MediaCatalogController {
    ...
    @PostMapping("/subjects/{subjectId}/seasons/{seasonId}/actions/reorder-episodes") public Mono<Void> reorderEpisodes(@RequestHeader("X-Ikaros-Actor-Id") UUID owner, @PathVariable UUID subjectId, @PathVariable UUID seasonId, @Valid @RequestBody ReorderMediaEpisodesRequest request) { return service.reorderEpisodes(owner, subjectId, seasonId, request); }
}
