...
public class PhotoController {
    ...
    @DeleteMapping("/albums/{albumId}") public Mono<ResponseEntity<Void>> deleteAlbum(@RequestHeader("X-Ikaros-Actor-Id") UUID o, @PathVariable UUID albumId, @RequestHeader(value = "If-Match", required = false) String ifMatch) { return service.deleteAlbum(o, albumId, IfMatchVersion.parse(ifMatch)).thenReturn(ResponseEntity.noContent().build()); }
